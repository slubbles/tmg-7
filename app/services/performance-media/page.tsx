...
export default function Page() {
  return (
    <main className="bg-[#FAF8F3]">
      <PageHero eyebrow="Services — Performance Media" title="Performance Media" accent="" desc="Paid media that moves with proof. Search, social, and programmatic deployment tied to approved plans and performance feedback." cta={<><Link href="/contact" className="bg-white text-black rounded-full px-6 py-3 text-sm font-semibold">Talk to TMG →</Link><Link href="/case-studies" className="rounded-full border border-white/20 px-6 py-3 text-sm font-semibold text-white">View case studies</Link></>} />
      <section className="container-custom py-12 md:py-16">
        <div className="grid md:grid-cols-3 gap-4">
          <div className="rounded-[24px] bg-white border border-black/10 p-6">
            ...
            <p className="mt-2 text-[13px] leading-relaxed text-black/60">Search, social, and programmatic deployment tied to approved plans and performance feedback.</p>
          </div>
          <div className="rounded-[24px] bg-white border border-black/10 p-6">
