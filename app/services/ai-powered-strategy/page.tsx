...
export default function Page() {
  return (
    <main className="bg-[#FAF8F3]">
      <PageHero eyebrow="Services — AI-Powered Strategy" title="AI-Powered Strategy" accent="" desc="Strategy powered by intelligence, not hype. We pair judgment with machine learning to size markets, prioritize segments, and choose the moves that earn the next dollar." cta={<><Link href="/contact" className="bg-white text-black rounded-full px-6 py-3 text-sm font-semibold">Talk to TMG →</Link><Link href="/case-studies" className="rounded-full border border-white/20 px-6 py-3 text-sm font-semibold text-white">View case studies</Link></>} />
      <section className="container-custom py-12 md:py-16">
        <div className="grid md:grid-cols-3 gap-4">
          <div className="rounded-[24px] bg-white border border-black/10 p-6">
            ...
            <p className="mt-2 text-[13px] leading-relaxed text-black/60">We pair judgment with machine learning to size markets, prioritize segments, and choose the moves that earn the next dollar.</p>
          </div>
          <div className="rounded-[24px] bg-white border border-black/10 p-6">
